...
| **고강민** | 소프트웨어전공 | 게임, 웹, 앱 |
| **이산** | 소프트웨어전공 | 웹 개발, 게임 개발, 여행, 체스, 지리, 역사 |
...
관심 분야에 개해 학부 과정보다 깊게 배운다

2.비주얼 컴퓨팅 연구실

전자공학부 나오셨는데 컴퓨터 그래픽스 관심있으셔서 가심

3.가상현실,3d,생성모델 이미지 생성 위주로 연구

기존에 있는걸 파인튜닝, 원래 있던 모델에 새로운 기술을 추가

스테이블 디퓨전- 공개되어 있음, 비디오를 잘 만들기 위해서. 원래 있던 모델을 추가학습

4.대학원생 생활

교수님이 조력자 역할을 하신다.

5. 트렌드에 따라서 생성모델 위주로 공부
6. 
6.석사 따고 나서 취준 준비하실 예정, 취업 경쟁력을 위해 대학원 들어오신거임

7.게임회사 가고 싶으셨는데 생성모델 공부하다가 보니까 회사를 폭넓게 지원하려고 전자공에서 소프트웨어학과 대학원으로 바꾸심

8.심도깊은 과정을 3,4학년때도 하는건지?

그래픽스 들으면 선형대수 수식들이 많이 쓰임,선이수과목들을 더 깊게 다룬다

9.수학 많이 안쓰는 대학원이 있나요?

데이터관리쪽은 수학 덜쓰지만 인공지능이 대세


![유레카 대학원생님](https://github.com/user-attachments/assets/a0b46cd0-e439-4d6c-9d89-112d0076e978)
...
- 프로젝트 진행 ✔️  
  ...
  - 그들이 만들어가는 세상 <br />
    1. why? 컴퓨터가 있는 곳까지 간 후 전원은 켜고 웹서핑을 해야하는 등 정보를 찾는 과정이 불편해서 만들게 됐을 것이다. 신문에서 일기 예보를 볼 때 실시간으로 바뀌지 않아서 실제 날씨가 일기 예보와 차이가 생기는 것이 불편해서 만들게 됐을 것이다.
    2. what? 게임, 웹서핑, 라이브 영상 등 모두 따로 해야했던 일들은 한 곳에서 할 수 있는 기기나 모든 행동에 인터넷이 상호작용하는 장치를 만들고 싶었을 것이다.
    3. how? 일상의 사소한 부분들을 어떻게 간편하게 할 수 있을지 상상하면서 만들었다. 또한 만약에 기기를 만들었는데 PC처럼 무겁거나 크면 가지고 다닐 수 없으니 최대한 소형화 시키려 했을 것이다.
  - 우리가 상상한 미래
<실시간 번역기>
...
<img width="1190" height="1683" alt="Image" src="https://github.com/user-attachments/assets/f7af6e9c-890f-4423-8603-1b458cd56252" />
https://drive.google.com/file/d/1h8OODoDD8mJGSHYwh0dko1YNRe9fjYXc/view?usp=sharing<br />
- 각오와 소감 나누기 ✔️  
